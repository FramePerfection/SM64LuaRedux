...
BreitbandGraphics = {
    ...
    renderers = {
        d2d = {
            ...
            draw_text = function(rectangle, horizontal_alignment, vertical_alignment, color, font_size, font_name, font_style, text)
                if text == nil then
                    text = ""
                end
                ...
                wgui.d2d_draw_text(rectangle.x, rectangle.y, rectangle.x + rectangle.width,
                    ...
                    font_size, font_style, d_horizontal_alignment, d_vertical_alignment)
            end,
